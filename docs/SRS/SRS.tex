...
\begin{enumerate}[label = NFR-\arabic*, left=\parindent, series=nfr]
    ...
    % \item The product shall allow the users to customize the appearance of the product by offering them options to change the theme, typography, and layout of the user interface.
    ...
    % \newline \textbf{Fit Criterion}: 90\% of a sample group of users shall agree that the customization options are easy to use and are intuitive.
\end{enumerate}
...
% \begin{enumerate}[nfr]
%     \item The product shall automatically save user preferences, such as font size, and the colour theme.
...
%     \newline \textbf{Fit Criterion}: The product shall be tested with at least 15 users who will be asked to set their preferences and then verify that the preferences have been saved and synchronized to other devices correctly. The success rate of this process shall be at least 95\%.
% \end{enumerate}
N/A
